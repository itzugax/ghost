...
-- ── BLOQUE 1.5: Columna burn_after_reading ──────────────────
...
-- ⚠️  Este cron solo borra filas de `drops`.
-- ⚠️  No elimina el archivo fisico del bucket `ghost-drop`.
-- ✅ Para limpieza real (DB + Storage), usa la Edge Function `supabase/functions/cleanup/index.ts`
--    y prográmala desde Supabase.
--
-- Solo deja este cron si entiendes esa limitacion.
